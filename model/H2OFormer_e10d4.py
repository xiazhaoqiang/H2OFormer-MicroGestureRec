...
class Encoder(nn.Module):
    ...
    def forward(self, x, joint_label, groups):
        ...
        x, e = self.l7(x, joint_label, groups, e)
        x, e = self.l8(x, joint_label, groups, e)
        x, e = self.l9(x, joint_label, groups, e)
        x, e = self.l10(x, joint_label, groups, e)
        return x
...
class Decoder(nn.Module):
    def __init__(self, num_of_heads, A, T, num_point, decoder):
        ...
        self.l2 = TCN_ViT_unit(24 * num_of_heads, 24 * num_of_heads, A, residual=True, num_of_heads=num_of_heads,
                               pe=True, T=T * 2, num_point=num_point, decoder=None, layer=2)
        self.l3 = TCN_ViT_unit(24 * num_of_heads, 24 * num_of_heads, A, residual=True, num_of_heads=num_of_heads,
                               pe=True, T=T * 2, num_point=num_point, decoder=decoder, layer=3)
        self.l4 = TCN_ViT_unit(24 * num_of_heads, 24 * num_of_heads, A, residual=True, num_of_heads=num_of_heads,
                               pe=True, T=T * 4, num_point=num_point, decoder=None, layer=4)
